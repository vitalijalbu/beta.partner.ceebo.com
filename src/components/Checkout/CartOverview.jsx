...
const CartOverview = () => {
  ...
  const [type, setOrderType] = useState("delivery");
  ...
  const [dropoff_deadline, setStoreDropoff] = useState();
  ...
  const handleCreateOrder = () => {
    ...
    const formData = {
      ...
      ref_area: customer_address?.ref_area,
  ...
  return (
    ...
    >
        ...
        <>
          ...
          <List mediaList>
            <ListItem
              ...
              subtitle={customer_address ? customer_address.name : ""}
      ...
      <List mediaList>
        <ListItem
          link="#"
          title={dropoff_deadline ? dropoff_deadline : "Seleziona orario"}
          subtitle="Orario selezionato"
          onClick={openDropoffPopup}
        >
          <Icon className="icon-slot-media" slot="media" f7="clock"></Icon>
        </ListItem>
      </List>
      {/* Summary order */}
        ...
        <ListItem
          ...
          after={
            cart.cart_subtotal > 0
              ? cart.cart_subtotal + " " + cart.currency_code
              : "0.00"
          }
        />
        <ListItem
          ...
          after={
            cart.purchase_fee > 0
              ? cart.purchase_fee + " " + cart?.currency_code
              : "0.00"
          }
        />
        <ListItem
          ...
          after={
            cart.delivery_fee > 0
              ? cart.delivery_fee + " " + cart?.currency_code
              : "0.00"
          }
        />
        <ListItem
          ...
          after={
            cart.cart_total > 0
              ? cart.cart_total + " " + cart.currency_code
              : "0.00"
          }
        />
      </List>
      ...
      <DropoffPopup
        ...
        onSubmit={setStoreDropoff}
        type={type}
      />
      <CheckoutPopup
        opened={checkoutPopup}
        close={closeCheckout}
        data={{"cart": cart, "customer": customer}}
