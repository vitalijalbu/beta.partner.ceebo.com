...
const ItemPopup = ({ opened, close, data }) => {
  ...
  const localSessionGuid = import.meta.env.VITE_APP_SESSION_GUID;
  const localListingId = import.meta.env.VITE_DEMO_LISTING_ID;
  ...
  const handleAdd = (e) => {
     ...
     const body = {
      session_guid: String(localSessionGuid),
      item_id: data.id,
