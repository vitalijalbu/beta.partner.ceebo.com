...
const Hardware = () => {
  ...
  return (
    <Page>
      <Navbar>
      <NavLeft>
        <Link iconF7="chevron_left" href="/settings">Impostazioni</Link>
      </NavLeft>
      <NavTitle>Hardware</NavTitle>
      <NavRight>
        <Link href="https://ceebo.tawk.help/" external>Aiuto?</Link>
      </NavRight>
      </Navbar>
      {/* */}
      <List simpleList>
      ...
      <BlockTitle>Dispositivi</BlockTitle>
      <List mediaList>
      {devices.map((data, i) => (
      ...
      <Button className="margin-bottom" large fill onClick={printPos}>Print test</Button>
      <Button className="margin-bottom" large outline onClick={printPos2}>Print test2</Button>
      </Block>
    </Page>
  );
}
